...
public class Inventory {
     ...
     */
    private final ConsoleColors consoleColors = new ConsoleColors();
    ...
    public void inspect(Item item) {
        if(item != null) {
            ...
            System.out.print(consoleColors.textColor("Nothing to inspect"));
        }
    }
    ...
    public void showInventory() {
        ...
        System.out.print(consoleColors.colorString(msg.isEmpty() ? "No visible items..." : String.valueOf(msg)));
    }
