 ...
 *         <li>File - A file to define all the object's qualities</li>
 *     </ul>
 * </blockquote>
 * @since 1.4
 * @version 1.1
 ...
 */
public class Component implements ComponentFunctions, Serializable {
     ...
     * @see ComponentFunctions
     */
    @Override
    public String textColor(String msg, String color) {
        consoleColors.setBackgroundColor(color);
